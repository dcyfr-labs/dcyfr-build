...
export const metadata: Metadata = {
  title: 'Privacy',
  description: 'What dcyfr.build collects, who processes it, and how to exercise your privacy rights.',
  openGraph: { url: 'https://dcyfr.build/privacy' },
};
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      <header className="space-y-3">
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Privacy at dcyfr.build</h1>
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-muted-foreground">
        <section className="space-y-3">
          ...
          <p>This notice describes what <span className="font-medium text-foreground">dcyfr.build</span> collects, and who processes it on our behalf. It sits alongside the DCYFR Labs privacy policy, which governs the wider estate.</p>
        ...
        <section className="space-y-3">
          ...
          <p>dcyfr.build is not directed to children under 13, and we do not knowingly collect their information.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-foreground">Changes</h2>
          <p>We update this notice when the services behind dcyfr.build change. The date at the top is the last revision.</p>
        </section>
      </div>
    </div>
  );
